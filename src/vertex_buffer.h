...
inline void mf_VertexBuffer::Bind()
{
	glBindVertexArray(vao_);
}

inline unsigned int mf_VertexBuffer::VertexCount() const
{
	return vertex_count_;
}

inline unsigned int mf_VertexBuffer::IndexDataSize() const
{
